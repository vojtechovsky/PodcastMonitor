...
namespace Podcaster.Helpers.Podcasts
{
    public class PodcastHelper
    {
        ...
        public PodcastHelper(string url)
        {
        ...
        public PodcastHelper(string url, string method)
            : this(url)
        {
        ...
        public PodcastHelper(string url, string method, string data)
            : this(url, method)
        {
